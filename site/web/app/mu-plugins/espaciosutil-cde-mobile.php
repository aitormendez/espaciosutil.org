...
if ((defined('WP_ENV') && WP_ENV === 'staging') || getenv('CDE_MOBILE_ENABLED') === '1') {
    foreach (['storage','progress','media','quiz','study','account','membership','stripe-membership','registration','api','legacy'] as $module) require_once __DIR__ . '/cde-mobile/' . $module . '.php';
}
