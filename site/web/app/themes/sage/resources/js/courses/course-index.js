...
export default function initCourseIndex() {
  ...
  if (container.dataset.courseIndexInitialized === 'true') {
    return;
  }

  container.dataset.courseIndexInitialized = 'true';
  ...
  const initializeCourseIndexChildren = (root) => {
    if (!root) {
      return;
    }
