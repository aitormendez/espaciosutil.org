...
<header id="banner" class="bg-negro/80 absolute z-40 w-full text-white xl:fixed">
  <div id="brand" class="flex flex-nowrap items-center justify-center xl:justify-start">
